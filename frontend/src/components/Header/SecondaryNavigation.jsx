const SecondaryNavigation = () => {
     ...
     const categories = [
      ...
      return (
        <div className="mx-auto max-w-7xl py-10 px-10 mt-5">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4 py-5">
            {categories.map((category) => (
              <div key={category.id} className="bg-white rounded-lg text-gray-500 p-5 border cursor-pointer hover:bg-gray-100 transition duration-400">
