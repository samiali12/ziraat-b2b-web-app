...
const Signup = () => {
    ...
    const [userData, setUserData] = useState({ email: '', password: '', role: 'buyer' })
    ...
    const onSubmit = async (data) => {
        await setUserData({ email: data.email, password: data.password, role: data.role })
            ...
            <div className="flex min-h-screen  bg-gray-100">
                ...
                <div className="flex flex-1 items-center justify-center px-6 lg:px-8">
                    <div className="sm:mx-auto my-10 sm:w-full h-auto sm:max-w-sm bg-white shadow-md rounded  px-10 py-5">
                        ...
                        <div className="flex item-center justify-center">
                            <h1 className="text-center text-xl py-4 font-semibold">Sign up</h1>
                        </div>

                        <form noValidate className="space-y-6 mt-4" onSubmit={handleSubmit(onSubmit)} method="POST">
                            <div>
                            ...
                            <div className="relative mt-2">
                                ...
                                >
                                    <option value="buyer">I want to become buyer ziraat</option>
                                    <option value="seller">I want to become sell on ziraat</option>
                            ...
                            <div className="md:block items-center mt-5">
                                <label
