                ...
                validUrl ?
                    ...
                    (
                        ...
                        <div className="flex items-center justify-center min-h-screen bg-gray-100">
                            ...
                            <div role="status">
                                <svg aria-hidden="true" className="w-10 h-10 mr-2 text-gray-100 animate-spin fill-[#28844b]" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <p className="text-green-600 m-4">
                                    We're validating your email address
                            </p>
